...
myApp.service('EmbedCombo', function(){
	...
	this.init = function(){
		...
		this.embeds.push({  //ok
			id: 'Instagram',
			code: '<div class="embed-container instagram embedElement"><iframe src="//instagram.com/p/$1/embed/" frameborder="0" scrolling="no" allowtransparency="true"></iframe></div>',
		...
		this.embeds.push({ //ok
			...
			code: '<div class="embed-container vine embedElement"><iframe src="//vine.co/v/$1/embed/simple" frameborder="0" scrolling="no" allowtransparency="true"></iframe><script async src="//platform.vine.co/static/scripts/embed.js" charset="utf-8"></script></div>',
		...
		this.embeds.push({  //ok
			id: 'Vimeo',
			code: '<div class="vimeo embedElement"><iframe src="//player.vimeo.com/video/$1" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>',
		...
		this.embeds.push({  //ok
			id: 'Dumpert',
			code: '<div class="dumpert embedElement"><iframe src="//www.dumpert.nl/embed/$1/$2/" frameborder="0" allowfullscreen></iframe></div>',
		...
		this.embeds.push({  //ok
				id: 'Twitch',
				code: '<div class="twitch embedElement"><iframe src="//player.twitch.tv/?channel=$1" frameborder="0" scrolling="no"></iframe><a href="//www.twitch.tv/$1?tt_medium=live_embed&tt_content=text_link" style="padding:2px 0px 4px; display:block; font-weight:normal; font-size:10px;text-decoration:underline;">Twitch Video</a></div>',
		...
		this.embeds.push({  //ok
			id: 'Soundcloud Track',
			code: '<iframe class="vimeo-embed embedElement" width="100%" height="166" scrolling="no" frameborder="no" src="//w.soundcloud.com/player/?url=//soundcloud.com/$1/$2&amp;show_artwork=true"></iframe>',
		...
		this.embeds.push({  //ok but some console errors
			id: 'Soundcloud Set',
			code: '<iframe class="soundcloud embedElement" width="100%" height="410" scrolling="no" frameborder="no" src="http://w.soundcloud.com/player/?url=://soundcloud.com/$1/sets/$2&amp;show_artwork=true"></iframe>',
		...
		this.embeds.push({ //ok
			...
			code: '<iframe class="spotify embedElement" src="//embed.spotify.com/?uri=spotify:$1:$2" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>',
		...
		this.embeds.push({ //ok
			...
			code: '<iframe class="spotify embedElement" src="//embed.spotify.com/?uri=spotify:user:$1:playlist:$2" width="300" height="380" frameborder="0" allowtransparency="true"></iframe>',
		...
		this.embeds.push({ //ok
			id: 'Webm',
			code: '<video class="webm embedElement" width="640" height="360" preload="metadata" controls="" src="$1"></video>',
		...
		this.embeds.push({ //ok
			id: 'Gfycat',
			code:'<iframe class="gfycat embedElement" width="640" height="360" src="https://gfycat.com/ifr/$1" frameborder="0" scrolling="no" style="-webkit-backface-visibility: hidden;-webkit-transform: scale(1);" ></iframe>',
		...
		this.embeds.push({ //ok
			id: 'Gifv',
			code: '<video class="gifv embedElement" width="640" height="360" autoplay loop muted><source type="video/webm" src="$1.webm"><source type="video/mp4" src="$1.mp4"></video>',
		...
		this.embeds.push({
			id: 'Liveleak',
			code: '<iframe width="640" height="360" class="embedElement" src="http://www.liveleak.com/ll_embed?i=$1" frameborder="0" allowfullscreen></iframe>',
		...
		this.embeds.push({
			id: 'Pornhub',
		  	code: '<iframe src="//www.pornhub.com/embed/$1" class="embedElement" frameborder="0" width="608" height="338" scrolling="no"></iframe>',
